# DevOps Homework — Linux to Docker
...
networking, Git and Docker. Each folder has its own README containing the
commands, their real captured output, and screenshots.
